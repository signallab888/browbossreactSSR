        ...
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger}>
              ...
              <motion.div variants={fadeUp} className="flex items-center gap-5 pt-6 border-t border-zinc-200">
                <div className="bg-white px-4 py-2 border border-zinc-100">
                  <img src="/images/yumi-logo.png" alt="YUMI Lashes & Brows" className="h-12 w-auto" />
                </div>
