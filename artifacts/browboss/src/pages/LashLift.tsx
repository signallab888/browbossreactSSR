          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger}>
              ...
              <motion.div variants={fadeUp} className="flex items-center gap-6 pt-6 border-t border-zinc-200">
                <img src="/images/yumi-logo.png" alt="YUMI Lashes & Brows" className="h-10 w-auto" />
            ...
            >
              <img src="/images/frame-pick-2-clean.jpg" alt="YUMI Lash Lift treatment" className="w-full h-full object-cover" style={{ objectPosition: "center 25%" }} />
            </motion.div>
          </div>
        </div>
      </section>
