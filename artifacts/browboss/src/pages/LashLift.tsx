        ...
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger}>
              ...
              <motion.div variants={fadeUp} className="flex flex-row items-center gap-6 pt-6 border-t border-zinc-200">
                <img src="/images/yumi-logo.png" alt="YUMI Lashes & Brows" className="h-16 w-auto max-w-[140px]" style={{ mixBlendMode: "multiply" }} />
                <span className="w-px h-6 bg-zinc-300 shrink-0" />
                <p className="text-[10px] tracking-[0.2em] uppercase text-zinc-400 leading-relaxed">Certified Provider · La Jolla</p>
              </motion.div>
            </motion.div>
            <motion.div
            ...
            >
              <img src="/images/frame-pick-2-clean.jpg" alt="YUMI Lash Lift treatment" className="w-full h-full object-cover object-center" />
            </motion.div>
          </div>
        </div>
      </section>
